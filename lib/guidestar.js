...
Guidestar.prototype.charityCheck = function(EIN, opts){
  opts = opts || {};
  var apiKey = opts.key || this.options.charityCheckAPIKey;
...
Guidestar.prototype.detail = function(orgID, opts){
  opts = opts || {};
  var apiKey = opts.key || this.options.detailAPIKey;
...
Guidestar.prototype.exchange = function(orgID, opts){
  opts = opts || {};
  var apiKey = opts.key || this.options.exchangeAPIKey;
...
Guidestar.prototype.search = function(query, opts){
  ...
  var apiKey = opts.key || this.options.searchAPIKey;
